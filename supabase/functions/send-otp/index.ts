...
serve(async (req) => {
  ...
  try {
    ...
    const res = await fetch('https://api.resend.com/emails', {
      ...
      body: JSON.stringify({
        from: 'KoraBiz Management System <onboarding@resend.dev>',
        to: [email],
        subject: 'KoraBiz - Your Verification Code',
        html: `
          <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
            <h1 style="color: #1d4ed8; text-align: center;">KoraBiz Management System</h1>
