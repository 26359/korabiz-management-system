...
export default function AdminReports() {
  ...
  const generateClientExcel = (client) => {
    ...
    XLSX.writeFile(wb, `KoraBiz_${client.full_name.replace(' ', '_')}_Report.xlsx`)
    setGenerating(false)
  }
  ...
  const generateClientPDF = (client) => {
    ...
    // Header
    doc.setFontSize(16)
    doc.text('KoraBiz Management System', 14, 15)
    doc.setFontSize(12)
    ...
    doc.save(`KoraBiz_${client.full_name.replace(' ', '_')}_Report.pdf`)
    setGenerating(false)
  }
